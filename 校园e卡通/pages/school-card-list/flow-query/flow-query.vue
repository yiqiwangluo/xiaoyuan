<template>
	<view class="content">
		...
		<transaction-card consumption_type="消费" consumption_time="2020-07-02 15:48:15" consumption_money="12" discounts_money="0"
		 consumption_id="1584987879845487487894" consumption_account="8484564684784878" merchant_name="梅州市职业技术学校" v-if="showTrue" />
		<transaction-card consumption_type="充值" consumption_time="2020-07-02 15:48:15" consumption_money="58" discounts_money="0"
		 consumption_id="1584987879845487487894" consumption_account="8484564684784878" merchant_name="梅州市职业技术学校" v-if="showFalse" />
		<transaction-card consumption_type="缴费" consumption_time="2020-07-02 15:48:15" consumption_money="200" v-if="showTrue"
		 discounts_money="0" consumption_id="1584987879845487487894" consumption_account="8484564684784878" merchant_name="梅州市职业技术学校" />
		<transaction-card consumption_type="房租" consumption_time="2020-07-02 15:48:15" consumption_money="1000" v-if="showTrue"
		 discounts_money="0" consumption_id="1584987879845487487894" consumption_account="8484564684784878" merchant_name="梅州市职业技术学校" />
		<transaction-card consumption_type="水电" consumption_time="2020-07-02 15:48:15" consumption_money="400" v-if="showTrue"
		 discounts_money="0" consumption_id="1584987879845487487894" consumption_account="8484564684784878" merchant_name="梅州市职业技术学校" />
	</view>
</template>
