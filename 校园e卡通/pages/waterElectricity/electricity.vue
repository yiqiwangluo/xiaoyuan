<template>
	<view>
		<view class="elec_top">
			<view class="elec_left">
				<view class="elec_left_title">
					选择缴电费地址
				</view>
				<view class="elec_left_content">
		...
		<view class="elec_middle">
			<view class="elec_middle_left">
				缴费金额
			</view>
			<view class="elec_middle_right">{{price}} 元</view>
		</view>
		<view class="elec_bottom">
			<view class="price_item" :class="{'active': isChange == index}"  v-for="(item, index) in list" :key="index" @click="clickBtn(index,item)">
					{{item}}元
			</view>
		</view>
		<view class="elec_button" @click="success=true">
			立即缴费
		</view>
